        ...
        <div className="container mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-6">
            <Link to="/" className="flex items-center gap-2.5">
              <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-amber-600 text-white shadow-sm shadow-amber-600/30">
            ...
            return (
              <Link
                ...
                className={`flex flex-col items-center gap-1 py-1 px-2 rounded text-xs ${
                  active ? 'text-amber-400 font-bold' : 'text-muted-foreground'
                }`}
              >
                <Icon className="h-4 w-4" />
                <span>{item.label}</span>
